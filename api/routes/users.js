    ...
    try {
      ...
      pool.getConnection((err, con) => {
        ...
        con.query(queryEmpresa, [empresa_id], (err, result) => {
          ...
          // Função auxiliar para inserir uma unidade e retornar seu id
          const inserirUnidade = (unidade) => {
            return new Promise((resolve, reject) => {
              const queryUnidade = `INSERT INTO unidades (nome_unidade, cnpj_unidade, cep_unidade, endereco_unidade, numero_unidade, bairro_unidade, cidade_unidade, uf_unidade, fk_contato_id, fk_empresa_id, ativo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
              const values = [unidade.nome_unidade, unidade.cnpj_unidade, unidade.cep_unidade, unidade.endereco_unidade, unidade.numero_unidade, unidade.bairro_unidade, unidade.cidade_unidade, unidade.uf_unidade, unidade.fk_contato_id, unidade.fk_empresa_id, unidade.ativo];
          ...
          // Função auxiliar para inserir um setor e retornar seu id
          const inserirSetor = (setor, fk_unidade_id) => {
            return new Promise((resolve, reject) => {
              const querySetor = `INSERT INTO setores (nome_setor, ambiente_setor, observacao_setor, fk_unidade_id, ativo, fk_empresa_id) VALUES (?, ?, ?, ?, ?, ?)`;
              const values = [setor.nome_setor, setor.ambiente_setor, setor.observacao_setor, fk_unidade_id, setor.ativo, setor.fk_empresa_id];
          ...
          // Função auxiliar para inserir um cargo
          const inserirCargo = (cargo, fk_setor_id) => {
            return new Promise((resolve, reject) => {
              const queryCargo = `INSERT INTO cargos (nome_cargo, descricao, func_masc, func_fem, func_menor, fk_setor_id, ativo, fk_empresa_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`;
              const values = [cargo.nome_cargo, cargo.descricao, cargo.func_masc, cargo.func_fem, cargo.func_menor, fk_setor_id, cargo.ativo, cargo.fk_empresa_id];
