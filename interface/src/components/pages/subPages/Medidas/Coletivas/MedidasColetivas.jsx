...
import CadastroMedidas from "./frmColetivas";
import GridMedidas from './GridColetivas';
import SearchInput from "../../components/SearchInput";

function MedidasColetivas() {
  ...
  const get = async () => {
    const med = await fetchMedidas('MC');
    setMedidas(med);
  }
  ...
  return (
    <div className="tab-content mt-14 mb-32">
      ...
      <div className="flex justify-center w-full">
        <div className="w-3/6">
          <SearchInput onSearch={handleSearch} placeholder="Buscar Medidas Coletivas..." />
        </div>
      </div>
...
export default MedidasColetivas;
