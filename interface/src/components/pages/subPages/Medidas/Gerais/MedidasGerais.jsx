...
import CadastroGerais from "./frmGerais";
import GridGerais from './GridGerais';
...
function Treinamentos() {
  ...
  const get = async () => {
    const med = await fetchMedidas('MG');
    setMedidas(med);
  }
  ...
  return (
    <div className="tab-content mt-14 mb-32">
      ...
      <div className="flex justify-center w-full">
        <div className="w-3/6">
          <SearchInput onSearch={handleSearch} placeholder="Buscar Medidas Gerais..." />
        </div>
      </div>
